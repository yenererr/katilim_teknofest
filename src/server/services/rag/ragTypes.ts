...
export const BANK_NAME_TO_ID: Record<string, string> = {
  ...
  "iktisat katılım": "iktisat-katilim",
  "iktisat katilim": "iktisat-katilim",
  iktisat: "iktisat-katilim",
  ...
  vakif: "vakif-katilim",
  "vakıf": "vakif-katilim",
  "vakif bankasi": "vakif-katilim",
  "vakıf bankası": "vakif-katilim",
  "ziraat katılım": "ziraat-katilim",
  "ziraat katilim": "ziraat-katilim",
  ziraat: "ziraat-katilim",
  "ziraat bankasi": "ziraat-katilim",
  "ziraat bankası": "ziraat-katilim",
  "ziraat banka": "ziraat-katilim",
};
